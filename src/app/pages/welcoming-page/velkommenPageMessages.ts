...
export const velkommenPageMessages: MessageFileFormat = {
    nb: {
        ...
        'page.velkommen.guide.tekst.1':
            'Denne søknaden er for deg som må være borte fra jobb for å ta vare på et barn, eller en person over 18 år, som på grunn av sykdom trenger pleie og omsorg hele tiden.',
        'page.velkommen.guide.tekst.2':
            'Når søknaden gjelder et barn, må barnet ha vært til behandling/utredning i sykehus, eller en annen spesialisthelsetjeneste. Gjelder søknaden en person over 18 år, må personen være utviklingshemmet og svært alvorlig syk.',
        ...
        'personopplysninger.6': 'Svar fra NAV',
        'personopplysninger.7': 'Du får et brev fra NAV når søknaden din er behandlet. Brevet inneholder:',
        'personopplysninger.7.1': 'begrunnelse for beslutningen og reglene som er brukt',
        'personopplysninger.7.2': 'hvordan du får innsyn i saksbehandlingen',
        'personopplysninger.7.3': 'hvordan du kan klage hvis du er uenig',
        'personopplysninger.8.1': 'Vil du vite mer om hvordan NAV behandler personopplysninger? Se ',
        'personopplysninger.8.2': 'nav.no/personvern',
        'personopplysninger.8.3': '.',
    },
};
