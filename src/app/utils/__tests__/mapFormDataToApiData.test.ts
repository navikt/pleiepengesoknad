...
describe('mapFormDataToApiData', () => {
    ...
    beforeAll(() => {
        ...
        resultingApiData = mapFormDataToApiData(formDataMock as SøknadFormData, barnMock, 'nb')!;
    });
    ...
    it("should set 'fodselsnummer' in api data to undefined if it doesnt exist, and otherwise it should assign value to 'fodselsnummer' in api data", () => {
        ...
        const result = mapFormDataToApiData(formDataWithFnr as SøknadFormData, barnMock, 'nb');
