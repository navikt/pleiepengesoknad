...
export function NewFormikDatepicker<FormField>({ validate, label, dateLimitations, ...otherProps }: Props<FormField>) {
    const intl = useIntl();
    return (
...
// export const NewFormikDatepickerWithIntl = injectIntl(NewFormikDatepicker);

export const FormikDatepicker = <T extends {}>(): React.FunctionComponent<FormikDatepickerProps<T> &
