        ...
        <>
            ...
            {tilsynsordning.svar === 'vet_ikke' && (
                <>
                    ...
                    {TilsynVetIkkeHvorfor.annet === tilsynsordning.vet_ikke.svar && tilsynsordning.vet_ikke.annet && (
                        <Box margin="l">
                            <ContentWithHeader
                                header={intlHelper(intl, 'steg.oppsummering.tilsynsordning.vetIkke.annet.header')}>
