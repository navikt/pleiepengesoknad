...
export default () => (
    <svg width="50px" height="62px" viewBox="0 0 50 62" version="1.1">
        ...
        <g id="v-copy" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="spotlight/-gjenstand--copy" transform="translate(2.000000, 0.000000)">
                    ...
                    <g id="Group">
                        ...
                        <g transform="translate(4.259259, 9.191781)">
                            ...
                            <path
                                ...
                                fill="#C9C9C9"
                            />
                            <g transform="translate(1.356653, 6.804305)" fill="#515658">
                                <g id="Group-2" transform="translate(11.560000, 4.080000)">
                                    <g id="Group">
                                        <polygon
                                            id="Fill-100"
                                            points="8.90953677 22.7047593 8.90953677 12.6552407 8.90953677 10.2 1.97114246 10.2 0 10.2 0 12.6552407 1.97114246 12.6552407 1.97114246 22.7047593 0 22.7047593 0 25.16 10.88 25.16 10.88 22.7047593"
                                        />
                                        <path
                                            d="M5.44,8.15933863 C7.6926309,8.15933863 9.52,6.3326309 9.52,4.08 C9.52,1.82670773 7.6926309,0 5.44,0 C3.18670773,0 1.36,1.82670773 1.36,4.08 C1.36,6.3326309 3.18670773,8.15933863 5.44,8.15933863"
                                            id="Fill-101"
                                        />
                                    </g>
                                </g>
